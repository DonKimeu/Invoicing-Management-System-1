...
<form method="post" id="invoice_form" action="<?php echo base_url();?>admin/ice_cream/create">
  <div class="table-responsive">
	<table class="table table-bordered table-striped display">
	  <tr>
		<center><h2 style="margin-top:10.5px;color:2ef2ef;">Create Medicine Invoice</h2></center>
	  </tr>
		<tr>
			<div class="row">
				<div class="col-md-5">
		...
		<tr>
			<div class="row" style="margin: 10px 15px;">
				...
				<input type="number" name="cash_paid" id="cash_paid" class="form-control col-md-8 input-sm cash_paid" placeholder="Enter the amount paid" required />
			</div>
		</tr>
		<tr>
			<div class="row" style="margin: 10px 15px;">
